defmodule LemonadeWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use LemonadeWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Lemonade.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Lemonade.Accounts.generate_user_session_token(user)
